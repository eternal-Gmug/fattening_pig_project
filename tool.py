...
from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout,
                              ...
                              QLineEdit, QComboBox, QColorDialog, QTabWidget, QSplitter, QCheckBox)
...
class AnnotationTool(QMainWindow):
    ...
    def load_video(self):
        ...
        if file_path:
            self.load_video_frames(file_path)
    def load_video_frames(self,file_path):
        ...
        self.export_frames(out_width,out_height,fourcc,self.config['output_video_path'])
        out =cv2.VideoWriter(self.config['output_video_path'],fourcc,fps,(out_width,out_height))
        while cap.isOpened():
    ...
    def export_frames(self,out_width,out_height,fourcc,out_video_path):
        """导出视频帧"""
        # 具体实现代码暂不生成
        pass
